...
from scheduler_mcp.tools.analysis import AnalyzeJobRequestResult
from scheduler_mcp.tools.feasibility import check_job_request_feasibility
from scheduler_mcp.tools.nl import ParseJobRequestResult
from scheduler_mcp.tools.submit import JobSubmissionResult, submit_job_request_to_flux
                ...
                "parts": [
                    {
                        "text": (
                            ...
                            "gpus_per_task=0, wall_time=null. "
